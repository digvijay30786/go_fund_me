...
import Trending from "./components/trendingtopic";
import SourceFund from "./components/sourcefunding";
    ...
    <div className="App">
      ...
      <Fund>
        ...
        <TopFund>
          ...
          <div>
            ...
            <div className="details">
              <span>Irvine, CA</span>
              <h4>
                {"Support Katie DiSimone and her family".substring(0, 24) +
                  "..."}
              </h4>
              <p>
                {"Hi, my name is Kate Farnsworth, and I have created this go fund me to raise".substring(
                  0,
                  60
                ) + "..."}
              </p>
              ...
              />
              <p>
                <strong>$224,438 raised</strong> of $300,000
              </p>
            </div>
          </div>
          {/* first Div End */}
          ...
          <div>
            ...
            <div className="details">
              ...
              <p>
                {"My name is Ronak Bakshi. I'm Sagar's best friend. I tried contacting Sagar on Thursday, July 15th to take him to ".substring(
                  0,
                  60
                ) + "..."}
              </p>
              ...
              />
              <p>
                <strong>$158,894 raised</strong> of $150,000
              </p>
            </div>
          </div>
          {/* Second Div End*/}
          ...
          <div>
            ...
            <div className="details">
              ...
              <p>
                {"My name is Rhonda. My son and daughter were hiking on a trail near Tucson, Arizona just a few".substring(
                  0,
                  60
                ) + "..."}
              </p>
              ...
              />
              <p>
                <strong>$100,547 raised</strong> of $750,000
              </p>
            </div>
          </div>
          {/* Third Div End*/}
        ...
        <div className="seemore">
          ...
          <div>
            <img src="https://imgur.com/AjI4HST.png" width="20px" />
          </div>
        </div>
      </Fund>
      ...
      <Trending>
        ...
        <div className="mainTrend">
          <div className="first">
            <img
              src="https://imgur.com/QHCYOsa.jpg"
              height="100%"
              width="100%"
            />
          </div>
          <div className="second">
            <p>
              ...
              severe economic impact on individuals, small businesses, and
            ...
            <p>
              ...
              affected by COVID-19. And with hundreds of thousands of
              individuals across the globe in quarantine, there is a growing
        ...
        <div className="mainTrend">
          <div className="first">
            <img
              src="https://imgur.com/s8UONNx.jpg"
              height="100%"
              width="100%"
            />
          </div>
          <div className="second">
            ...
            <p>
              Start a GoFundMe to raise money to help yourself and others during
              this difficult time. Read our blog post{" "}
              <a href="">
      ...
      <SourceFund>
        ...
        <div className="sourceClass">
          <div className="flexImg">
            <div>
              <img src="https://imgur.com/TGdWYJZ.png" width="38px" />
            </div>
            <div>
              <h5>Worldwide leader</h5>
              <p>
                GoFundMe is trusted around the world for its simple, reliable
          ...
          <div className="flexImg">
            <div>
              <img src="https://imgur.com/E19g3FC.png" width="38px" />
            </div>
            <div>
              <h5>Simple setup</h5>
              <p>
          ...
          <div className="flexImg">
            <div>
              <img src="https://imgur.com/Ocp8J5P.png" width="38px" />
            </div>
            <div>
              <h5>Secure</h5>
              <p>
          ...
          <div className="flexImg">
            <div>
              <img src="https://imgur.com/VD0wvI7.png" width="38px" />
            </div>
            <div>
              <h5>Mobile app</h5>
              <p>
          ...
          <div className="flexImg">
            <div>
              <img src="https://imgur.com/qKnBv4j.png" width="38px" />
            </div>
            <div>
              <h5>Social reach</h5>
              <p>
          ...
          <div className="flexImg">
            <div>
              <img src="https://imgur.com/oujQx2g.png" width="38px" />
            </div>
            <div>
      ...
      <Appstore>
        <div className="play">
          <div className="pic">
            <img
              src="https://imgur.com/4s277RZ.png"
              width="100%"
              height="100%"
            />
          </div>
          <div className="avaliable">
            ...
            <div className="icon">
              <div>
                <img
                  src="https://imgur.com/xK3PRAX.png"
                  width="150px"
                  height="45px"
                />
              </div>
              <div>
                <img
                  src="https://imgur.com/OTF5ymW.png"
                  width="150px"
                  height="45px"
                />
              </div>
        ...
        <TopFund>
          ...
          <div>
            ...
            <div className="details">
              ...
              <h4>
                {"Rajasthan Samgrah Kalyan Sansthan - RSKS India".substring(
                  0,
                  24
                ) + "..."}
              </h4>
