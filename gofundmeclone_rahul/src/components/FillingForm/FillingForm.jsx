    ...
    return (
        <div >
            ...
            <form onSubmit={postLetsStartInfo}>
                <label htmlFor="country">Where do you live?
                ...
                <input type="text" name="postcode" placeholder="Search for your postcode" onClick={() => setPostCodeModal(true) } value={letsStartInfo !== undefined ? letsStartInfo.postcode :  ''} />
                ...
                <select name="fund-reason" onChange={updateLetsStartInfo}>
                    ...
                    <option value="Babies,Children,Family">Babies, Children &amp; Family</option>
                    ...
                    <option value="Competitions,Pageants">Competitions &amp; Pageants</option>
                    <option value="Creative Arts,Music,Film">Creative Arts, Music &amp; Film</option>
                    <option value="Dreams,HopesNWishes">Dreams, Hopes &amp; Wishes</option>
                    ...
                    <option value="Missions,Faith,Church">Missions, Faith &amp; Church</option>
            ...
            <p style = {{fontSize:'14px'}}>By continuing, you agree to the GoFundMe terms and acknowledge receipt of our privacy policy.</p>
        </div>
    )
}
            ...
            <form onSubmit={postTargetMoney}>
                <label htmlFor="">
                    ...
                    <div className= {styles.targetMoneyInput}>
                        <BiEuro/>
                        <input onChange={ (e) => setTargetMoney(e.target.value)} value={targetMoney} type="text" name="target-money" placeholder="Enter target amount"/>
                    </div>
                </label>
    ...
    return (
        <div>
            ...
            <form>
                ...
                <button className = {nextBtn ? styles.show : styles.hide} onClick={postImage}>Next</button>
            </form>
        </div>
    )
}
...
const PostCodeModal = ({ setPostCodeModal , setLetsStartInfo , letsStartInfo}) => {
    ...
    `
    return <StyledPostCodePopup>
        <header>
            <nav onClick={()=>setPostCodeModal(false)}><CgClose/></nav>
        </header>
        <div className='postCodeBody'>
            ...
            <StyledPostCodeResultCont>
                <div onClick={()=>setPostCode('924 95 - Ammarnäs, Västerbottens län')}>924 95 - Ammarnäs, Västerbottens län</div>
                <div onClick={()=>setPostCode('98107 - Abisko, Norrbottens län')}>98107 - Abisko, Norrbottens län</div>
                <div onClick={()=>setPostCode('441 16 - Alingsås, Västra Götal län')}>441 16 - Alingsås, Västra Götalands län</div>
                <div onClick={()=>setPostCode('441 17 - Alingsås, Västra Götal län')}>441 17 - Alingsås, Västra Götalands län</div>
                <div onClick={()=>setPostCode('441 20 - Alingsås, Västra Götal län')}>441 20 - Alingsås, Västra Götalands län</div>
            </StyledPostCodeResultCont>
        </div>
    </StyledPostCodePopup>
}
